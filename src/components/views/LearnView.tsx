    ...
    <div className="space-y-4">
      ...
      {activeTab === 'nutrition' && (
        <div className="p-4 rounded-3xl bg-white border border-[#E8EFF7] shadow-xs space-y-3">
          ...
          <div className="space-y-3 text-xs text-[#5A677D] leading-relaxed">
      ...
      {activeTab === 'meds' && (
        <div className="p-4 rounded-3xl bg-white border border-[#E8EFF7] shadow-xs space-y-3">
          <div className="flex items-center gap-2 border-b border-[#F0F4FA] pb-2">
            ...
            <h3 className="text-xs font-black text-[#192231]">
              Maternal Supplements & Side Effects
            </h3>
          </div>
      ...
      {activeTab === 'lactation' && (
        <div className="p-4 rounded-3xl bg-white border border-[#E8EFF7] shadow-xs space-y-3">
          <div className="flex items-center gap-2 border-b border-[#F0F4FA] pb-2">
            ...
            <h3 className="text-xs font-black text-[#192231]">
              Lactation Foundations & Newborn Care
            </h3>
          </div>
      ...
      {activeTab === 'schemes' && (
        <div className="space-y-3">
          <div className="p-3.5 rounded-2xl bg-[#F0F7FF] border border-[#BAE6FD]">
